...
last1 = text1[text1.length - 1];
last2 = text2[text2.length - 1];
...
function frontAgain(wurd) {


if(wurd[0] + wurd[1] == wurd[wurd.length - 2] + wurd[wurd.length-1] ){
...
function cigarParty(numCigs, isWeeknd){

	if((numCigs >= 40 & numCigs <= 60) & isWeeknd == false || ((numCigs >= 40) & isWeeknd == true)){
...
function filterBigNumbers(array, x){
